...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            /*
            ((AtacticApplication)LoginActivity.this.getApplication()).setUserId(1);
            ((AtacticApplication)LoginActivity.this.getApplication()).setUserName("jaime@email.es");
            ((AtacticApplication)LoginActivity.this.getApplication()).setPassword("password");
            */
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        //Create fragmentAdapter to tell the AutoCompleteTextView what to show in its dropdown list.
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (response !=null){
                if (response.isOk()){
                    // Set global variables for user authorization in future API calls
                    // Currently storing the user's numeric ID
                    // TODO Change this for a token
                    try{
