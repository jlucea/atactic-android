    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            if (success) {
                ...
                ((SmartPathApplication)SimpleLoginActivity.this.getApplication()).setUserId(userId);
                ((SmartPathApplication)SimpleLoginActivity.this.getApplication()).setUserName(mEmail);
                ((SmartPathApplication)SimpleLoginActivity.this.getApplication()).setPassword(mPassword);
