...
import app.smartpath.android.smartpath.connect.LoginResponse;
            ...
            if (response !=null){
                if (response.isOk()){
                    ...
                    try{
                        ...
                        ((SmartPathApplication)LoginActivity.this.getApplication()).setUserId(userId);
                        ((SmartPathApplication)LoginActivity.this.getApplication()).setUserName(mEmail);
                        ((SmartPathApplication)LoginActivity.this.getApplication()).setPassword(mPassword);
                        return true;
